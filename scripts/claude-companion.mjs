 ...
 * - MODEL_ALIASES: opus, sonnet, and haiku are delegated to Claude CLI aliases
...
function printUsage() {
  console.log(
    [
      ...
      "  node scripts/claude-companion.mjs transfer [--source <file>|--prompt-file <file>] [--model <model|opus|sonnet|haiku>] [--effort <auto|low|medium|high|xhigh|max>]",
